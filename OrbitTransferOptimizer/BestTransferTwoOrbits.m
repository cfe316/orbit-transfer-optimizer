...
BestTransferTwoOrbits[oo1_, oo2_]:= Block[{
 ...
 minnustep, nustep1, nustep2, mint},
	...
	nustep1 = Min[(nuh1 - nul1)/8., minnustep];
	{nul2, nuh2} = o2["\[Nu]Range"];
	nustep2 = Min[(nuh2 - nul2)/8., minnustep];
...
ProcessBurn[b_] := Block[{ob},
	...
	ob["KSP Navball"] = OrbitTransferOptimizer`Heading`KSPHeadingFromCartesian[ob]["KSPNavball"];
	ob["LVLH Heading"] = OrbitTransferOptimizer`Heading`LVLHHeadingFromCartesian[ob]["LVLH"];
	ob
]
